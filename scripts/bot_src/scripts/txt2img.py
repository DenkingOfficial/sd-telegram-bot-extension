...
bot_txt2img_files = os.path.join(
...
class Txt2Img:
    ...
    def _get_data_for_variations_and_regen(self, call):
        ...
        main_folder = f"{bot_txt2img_files}/{username}/"
    ...
    def process(self, call=None):
        ...
        path = f"{bot_txt2img_files}/{self.user_info['username']}/{self.user_info['clean_prompt']}-{self.job_id}"
