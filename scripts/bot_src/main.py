...
bot_static_files = os.path.join(os.path.dirname(os.path.realpath(__file__)), "static")
queue = []

app = Client(
    "MidjourneyDiffusion",
    api_id=shared.opts.data.get("tg_api_id"),
    api_hash=shared.opts.data.get("tg_api_hash"),
    bot_token=shared.opts.data.get("tg_bot_token"),
)


@app.on_message(filters.command(["start"], prefixes=["/", "!"]))
async def start(client, message):
    start_image = f"{bot_static_files}/startImg.png"
